			...
			<div class="card mb-3">
				...
				<div class="list-group list-group-flush">
					...
					<a href="#" class="list-group-item list-group-item-action d-flex ps-3">
						...
						<div class="flex-fill">
							<div class="fw-500 text-dark">Investigate adding markdownlint</div>
					...
					<a href="#" class="list-group-item list-group-item-action d-flex ps-3">
						...
						<div class="flex-fill">
							<div class="fw-500 text-dark">Add a "Submit a Resource" form</div>
					...
					<a href="#" class="list-group-item list-group-item-action d-flex ps-3">
						...
						<div class="flex-fill">
							<div class="fw-500 text-dark">Custom control border color missing on focus</div>
					...
					<a href="#" class="list-group-item list-group-item-action d-flex ps-3">
						...
						<div class="flex-fill">
							<div class="fw-500 text-dark">New design for corporate page</div>
			...
			<div class="card mb-3">
				...
				<div class="list-group list-group-flush">
					...
					<div class="list-group-item d-flex px-3">
						...
						<div class="flex-fill">
							<div class="fw-600 text-dark">Mobile app autoclose on iOS</div>
			...
			<div class="card mb-3">
				...
				<div class="list-group list-group-flush">
					...
					<div class="list-group-item d-flex px-3">
						...
						<div class="flex-fill">
							<div class="fw-600 text-dark">React version missing daterangepicker</div>
