			...
			return {
				...
				annotations: {
					...
					xaxis: [{
						...
						strokeDashArray: 0,
						borderColor: appVariable.color.gray900,
						label: {
							borderColor: appVariable.color.gray900,
							style: {
								color: appVariable.color.white,
								background: appVariable.color.gray900,
							},
							text: 'Anno Test',
						}
					}, {
...
<template>
	...
	<div class="row">
		...
		<div class="col-xl-6 mb-3">
			<!-- BEGIN card -->
			<card class="text-white text-opacity-70 h-100 overflow-hidden">
		...
		<div class="col-xl-6">
			...
			<div class="row">
				...
				<div class="col-sm-6">
					...
					<!-- BEGIN card -->
					<card class="mb-3 overflow-hidden fs-13px border-0 bg-gradient-custom-teal" style="min-height: 199px;">
						<!-- BEGIN card-img-overlay -->
						<card-img-overlay class="mb-n4 me-n4 d-flex" style="bottom: 0; top: auto;">
