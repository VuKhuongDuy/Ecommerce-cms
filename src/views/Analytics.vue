...
export default {
	...
	data() {
			...
			tooltips: {
				...
				callbacks: {
					...
					labelColor: function(tooltipItem, chart) {
						return {
							borderColor: 'rgba('+ appVariable.color.whiteRgb +', .75)',
							backgroundColor: chart.data.datasets[tooltipItem.datasetIndex].color
						};
					},
					labelTextColor: function(tooltipItem, chart) {
						return appVariable.color.white;
					}
				}
			},
			scales: {
		...
		var chart3Options = chartOptions;
		chart3Options.scales = {
			yAxes: {
				ticks: {
					beginAtZero: true,
					min: 0,
		...
		var chart4Options = chartOptions;
		...
		var chart5Options = chartOptions;
		chart5Options.scales = {
			yAxes: {
				ticks: {
					beginAtZero: true,
					min: 0,
