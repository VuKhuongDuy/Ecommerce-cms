					...
					<div class="col-xl-9">
						...
						<div id="basicUsage" class="mb-5">
							...
							<p>
								...
								Please read the <a href="https://getbootstrap.com/docs/5.2/components/card/" target="_blank">official Bootstrap documentation</a> for the full list of options.
							</p>
							<card>
								<card-body>
									<div class="row">
								...
								<card-body>
									<div class="row">
										<div class="col-xl-6">
											...
											<card class="border-primary bg-primary bg-opacity-25 text-primary mb-3">
												<card-header class="border-primary fw-bold small text-primary">HEADER</card-header>
												<card-body>
										...
										<div class="col-xl-6">
											...
											<card class="border-primary mb-3">
												<card-header class="border-primary text-primary fw-bold small">HEADER</card-header>
												<card-body>
