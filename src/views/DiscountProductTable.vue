          ...
          <tbody>
            <tr>
              ...
              <td class="align-middle">
                <span
                  class="badge bg-gray-100 text-black text-opacity-50 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i
                    class="fa fa-circle text-gray-500 fs-9px fa-fw me-5px"></i>
                  Fulfilled</span>
              </td>
            ...
            <tr>
              ...
              <td class="py-1 align-middle">
                <span
                  class="badge bg-orange bg-opacity-20 text-orange px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i
                    class="fa fa-circle fs-9px fa-fw me-5px"></i>
                  Pending</span>
              </td>
              <td class="align-middle">
                <span
                  class="badge bg-yellow bg-opacity-50 text-black text-opacity-50 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i
                    class="fa fa-circle fs-9px fa-fw me-5px"></i>
                  Unfulfilled</span>
              </td>
            ...
            <tr>
              ...
              <td class="align-middle">
                <span
                  class="badge bg-primary bg-opacity-20 text-primary px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i
                    class="fa fa-circle text-primary text-opacity-80 fs-9px fa-fw me-5px"></i>
            ...
            <tr>
              ...
              <td class="align-middle">
                <span
                  class="badge bg-danger bg-opacity-30 text-black text-opacity-50 px-2 pt-5px pb-5px rounded fs-12px d-inline-flex align-items-center"><i
                    class="fa fa-circle fs-9px fa-fw me-5px text-danger text-opacity-80"></i>
